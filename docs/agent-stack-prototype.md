# PM3 Command Center v1 (Agent Stack Prototype)

> This document preserves the original repository README, which described an unrelated prior
> prototype (a Slack-based AI agent stack for routing daily inputs). It predates and is unrelated
> to the PM3 Trading Command Center landing page now built in this repository's root
> (`app/`, `components/`, `lib/`, etc.). Kept here for reference.
